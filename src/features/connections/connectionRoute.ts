...
import { acceptFriendshipController, countFriendsController, listingFriendshipController, rejectFriendshipController, requestFriendShipController } from "./connectionController";

export async function connectionRoutes(app: FastifyInstance) {

    app.get('/connetctions/friendship/listing', { preHandler: authenticate }, listingFriendshipController);
    app.get('/connetctions/friendship/count', { preHandler: authenticate }, countFriendsController);
